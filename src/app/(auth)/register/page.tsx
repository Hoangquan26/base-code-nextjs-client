        ...
        <div className="flex w-full flex-col justify-center overflow-y-auto px-4 py-8 sm:px-6 relative z-10">
            <div className="mx-auto w-full max-w-sm lg:w-[420px]">
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                    <button onClick={() => handleOauth('google')} className="flex w-full items-center justify-center gap-2 rounded-lg bg-background-light dark:bg-slate-800 border border-slate-200 dark:border-slate-700 px-4 py-2.5 text-sm font-semibold text-slate-700 dark:text-white hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors">
                    ...
                    <button onClick={() => handleOauth('facebook')} className="flex w-full items-center justify-center gap-2 rounded-lg bg-background-light dark:bg-slate-800 border border-slate-200 dark:border-slate-700 px-4 py-2.5 text-sm font-semibold text-slate-700 dark:text-white hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors">
                        <svg aria-hidden="true" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
